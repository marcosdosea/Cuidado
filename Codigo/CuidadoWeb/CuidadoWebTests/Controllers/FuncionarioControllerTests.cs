		...
		private static IEnumerable<Funcionario> GetTestFuncionarios()
		{
			return new List<Funcionario>
			{
				new Funcionario
				{
					...
					Cpf = "123.456.789-00",
					DataNascimento = DateTime.Parse("1992-10-27"),
					DataAdmissao = DateTime.Parse("2015-01-01"),
					Cargo = "Faxineira",
					Status = "Ativo",
					Salario = 3100.00m,
					NumeroCasa = 11,
				...
				new Funcionario
				{
					...
					Cpf = "123.456.700-00",
					DataNascimento = DateTime.Parse("1990-08-02"),
					DataAdmissao = DateTime.Parse("2020-01-01"),
					Cargo = "Zelador",
					Status = "Ativo",
					Salario = 3100.00m,
					NumeroCasa = 26,
				...
				new Funcionario
				{
					...
					DataAdmissao = DateTime.Parse("2021-01-01"),
					Cargo = "Cuidadora",
					Status = "Ativo",
					Salario = 4200.00m,
					NumeroCasa = 12,
